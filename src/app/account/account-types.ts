...
export type ProfileData = { user: { name: string | null; email: string; createdAt: string; role: "USER" | "ADMIN" | "DEV" | "NPN1_DEV" }; inventory: InventoryItem[]; operations: Operation[]; transactions: Transaction[]; tickets: Ticket[] };
