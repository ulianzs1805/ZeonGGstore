...
export default function UpgradePage() {
  ...
  const leftFragmentItem = animating && result && phase === "gather" && result.success ? displayTarget : displayInput; const leftFragmentMode: FragmentMode = animating && leftFragmentItem ? (phase === "gather" ? "gather" : "burst") : null; const rightFragmentItem = animating && phase === "burst" ? displayTarget : null; const rightFragmentMode: FragmentMode = rightFragmentItem ? "burst" : null;
