...
function ShardPack({ item, phase, particles }: { item: Item; phase: "burst" | "gather"; particles: Particle[] }) {
  ...
  return <div className="pointer-events-none absolute inset-0 z-40 overflow-visible">
    ...
    <style jsx>{`
      ...
      @keyframes upgradeShardGather{0%{opacity:0;transform:translate(calc(var(--burst-x) * .22),calc(var(--burst-y) * .22)) rotate(var(--r)) scale(.34);filter:brightness(1.7) saturate(1.28) drop-shadow(0 0 15px rgba(196,181,253,.62))}12%{opacity:1;transform:translate(calc(var(--burst-x) * .15),calc(var(--burst-y) * .15)) rotate(calc(var(--r) * .62)) scale(.58)}70%{opacity:1;filter:brightness(1.2) saturate(1.1)}100%{opacity:0;transform:translate(0,0) rotate(0deg) scale(1);filter:brightness(1.03) saturate(1.03)}}12%{opacity:1;transform:translate(calc(var(--burst-x) * .15),calc(var(--burst-y) * .15)) rotate(calc(var(--r) * .62)) scale(.58)}70%{opacity:1;filter:brightness(1.2) saturate(1.1)}100%{opacity:0;transform:translate(0,0) rotate(0deg) scale(1);filter:brightness(1.03) saturate(1.03)}}12%{opacity:1;transform:translate(calc(var(--burst-x) * .15),calc(var(--burst-y) * .15)) rotate(calc(var(--r) * .62)) scale(.58)}70%{opacity:1;filter:brightness(1.2) saturate(1.1)}100%{opacity:0;transform:translate(0,0) rotate(0deg) scale(1);filter:brightness(1.03) saturate(1.03)}}
    `}</style>
  </div>;
}
