...
function DepositContent() {
  ...
  const createPayment = async () => {
    setError("");
    if (value < 2 || value > 40000) { setError("Сумма пополнения — от 2 ₽ до 40 000 ₽."); return; }
    setLoading(true);
    try {
