...
export default function PromoCodesPage() {
  ...
  const activate = async () => {
    ...
    if (!value || busy) {
      if (!value) setMessage("Введи промокод.");
      return;
    }
