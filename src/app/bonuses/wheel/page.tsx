...
type ResultMetadata = { letter?: string; slotId?: string; zeonggUnlocked?: boolean; [key: string]: unknown };
type Result = { rewardType: string; rewardValue: number | null; caseId: string | null; label: string; mode?: string; metadata?: ResultMetadata; letterState?: LetterState; sectorIndex?: number };
